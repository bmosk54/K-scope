  ...
  claims: [
    {
      ...
      polarity: "present",
      verdict: "GROUNDED",
      scores: { necessity: 0.13, sufficiency: 0.51, specificity: 0.80 },
      scores_raw: { necessity_readout: 1.0, sufficiency_flip: 1.0, specificity_1_minus_cos: 0.936 },
      contrast_validation: {
        heldout_auroc: 1.0,
    ...
    },
    {
      ...
      polarity: "absent",
      verdict: "GROUNDED",
      scores: { necessity: 0.01, sufficiency: 0.51, specificity: 0.79 },
      scores_raw: { necessity_readout: 1.0, sufficiency_flip: 1.0, specificity_1_minus_cos: 0.932 },
      contrast_validation: {
        heldout_auroc: 1.0,
        intensity_collinearity: 0.52,
        valid: true,
    ...
    },
    {
      ...
      polarity: "present",
      verdict: "GROUNDED",
      scores: { necessity: 0.25, sufficiency: 0.53, specificity: 0.89 },
      scores_raw: { necessity_readout: 1.0, sufficiency_flip: 1.0, specificity_1_minus_cos: 0.976 },
      contrast_validation: {
        heldout_auroc: 1.0,
    ...
    },
    {
      ...
      polarity: "present",
      verdict: "WEAK",
      scores: { necessity: 0.67, sufficiency: 0.50, specificity: 0.84 },
      scores_raw: { necessity_readout: 1.0, sufficiency_flip: 0.995, specificity_1_minus_cos: 0.953 },
      contrast_validation: {
        heldout_auroc: 1.0,
...
window.DESIGNED_PROBES = {
  ...
  n_probes: 8,
  probes: [
    { concept: "immune infiltration in tumor", contrast: "LYM vs TUM", auroc: 1.0, intensity_r: 0.237, gate: "PASS", sufficiency: 0.51, random_null: 0.01 },
    { concept: "desmoplastic stromal reaction", contrast: "STR vs TUM", auroc: 1.0, intensity_r: 0.581, gate: "PASS", sufficiency: 0.51, random_null: 0.03 },
    { concept: "stromal vs immune composition", contrast: "STR vs LYM", auroc: 1.0, intensity_r: 0.646, gate: "REJECT", sufficiency: 0.51, random_null: 0.0 },
    { concept: "tumor necrosis burden", contrast: "DEB vs TUM", auroc: 0.999, intensity_r: 0.128, gate: "PASS", sufficiency: 0.51, random_null: 0.01 },
    { concept: "mucinous microenvironment", contrast: "MUC vs TUM", auroc: 0.996, intensity_r: 0.426, gate: "PASS", sufficiency: 0.51, random_null: 0.0 },
    { concept: "peritumoral immune exclusion", contrast: "LYM vs STR", auroc: 1.0, intensity_r: 0.646, gate: "REJECT", sufficiency: 0.51, random_null: 0.0 },
    { concept: "normal mucosa displacement", contrast: "NORM vs TUM", auroc: 1.0, intensity_r: 0.172, gate: "PASS", sufficiency: 0.51, random_null: 0.0 },
    { concept: "adipose infiltration of stroma", contrast: "ADI vs STR", auroc: 1.0, intensity_r: 0.229, gate: "PASS", sufficiency: 0.51, random_null: 0.0 },
  ],
  cap_threshold: 0.6,
  note:
...
window.MODEL_COMPARISON = [
  {
    ...
    sufficiency_concept: 0.51,   // calibrated steering-AUC (raw full-width flip = 1.0)
