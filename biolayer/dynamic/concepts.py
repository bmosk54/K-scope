...
_CELL_CONCEPTS = (
    ...
    ConceptSpec("endothelial", CELL.name, "ENDO", "FIB", ("CANCER", "LYM"),
                ("endothelial", "endothelium", "vascular lining", "vasculature",
                 "vascularity", "blood vessel", "microvessel"),
                "endothelial cell vs fibroblast"),
    ConceptSpec("red_blood_cell", CELL.name, "RBC", "ENDO", ("FIB", "SMC"),
                ("red blood cell", "erythrocyte", "rbc", "hemorrhage", "haemorrhage"),
                "RBC vs endothelial"),
